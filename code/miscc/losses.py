...
def discriminator_loss(netD, real_imgs, fake_imgs, conditions,
                       real_labels, fake_labels, words_embs, cap_lens, image_encoder,
                       class_ids, w_words_embs, wrong_cap_len, wrong_cls_id):
    # Forward
    ...
    matched = word_level_correlation(region_features, words_embs, cap_lens, batch_size, class_ids,real_labels)
    mismatched = word_level_correlation(region_features, w_words_embs, wrong_cap_len, batch_size,
...
def generator_loss(netsD, image_encoder, fake_imgs, real_labels,
    ...
    for i in range(numDs):
        ...
        region_features = style_loss(real_img)[0]
        fake_features = style_loss(fake_img)[0]
        perceptual_loss += F.mse_loss(region_features, fake_features)
